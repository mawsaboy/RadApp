...
public class RowLayout7 extends ArrayAdapter<String>{
	Context context;
	int images[];
	String [] titles;
	public RowLayout7(Context con, String[] name, int image[]){	
		super(con,R.layout.rowlayout7,R.id.headname,name);
		this.context = con;
		this.images = image;
		this.titles = name;
...
public class MyViewHolder{
	...
	public View getView(int position, View convertView , ViewGroup parent){
		...
		row = inflater.inflate(R.layout.rowlayout7, parent, false);
